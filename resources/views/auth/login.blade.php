        ...
        <form id="loginForm" method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button"
                            id="togglePassword"
                            class="absolute right-0 top-0 h-full flex items-center justify-center px-3 text-gray-500 hover:text-gray-700 focus:outline-none transition-colors"
                            aria-label="Show password"
                            aria-pressed="false">
                        <svg id="eyeClosedIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <svg id="eyeOpenIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
